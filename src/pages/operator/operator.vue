      ...
      <div v-if="edit.open != ''">
        <el-form ref="form" :model="edit.data" label-width="80px">
          ...
          <el-form-item label="access_key">
            <el-input :placeholder="edit.open=='修改'?'如无修改则不填':''" v-model="edit.data.access_key"></el-input>
          </el-form-item>
          <el-form-item label="secret_key">
            <el-input :placeholder="edit.open=='修改'?'如无修改则不填':''" v-model="edit.data.secret_key"></el-input>
          </el-form-item>
